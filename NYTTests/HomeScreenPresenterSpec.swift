        ...
        describe("HomeScreenPresenter") {
            ...
            describe("when .getArticles()") {
                ...
                describe("when .page is 0") {
                    ...
                    describe("when .reachabilityService.connectionIsUnavailable is true") {
                        beforeEach {
                            let mockService = MockReachabilityService()
                            mockService.connectionIsUnavailableToReturn = true
                            uut?.reachabilityService = mockService
                    ...
                    describe("when .reachabilityService.connectionIsUnavailable is false") {
                        beforeEach {
                            let mockService = MockReachabilityService()
                            mockService.connectionIsUnavailableToReturn = false
                            uut?.reachabilityService = mockService
                            uut?.getArticles(searchText: "some text", page: 0)
                        }
